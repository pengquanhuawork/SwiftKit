...
/**
 Fill the rect region of with a linear gradient from [0.0, 0.0] to [size.width, size.height]. Colors are linearly interpolated between startPoint to endPoint based on the values of the gradient's locations.
