...
/**
  A switch to reuse a NSDateFormat object in btd_stringWithFormat, btd_dateWithString methods.
  Reuse a NSDateFormat object can reduce the time cost of initiating NSDateFormat frequently.
 */
@property(nonatomic, assign, class) BOOL btd_optimizeDateFormatterEnabled;
...
/**
 ...
 @return The current mach time.
 */
FOUNDATION_EXPORT uint64_t BTDCurrentMachTime(void) __attribute__((used));
